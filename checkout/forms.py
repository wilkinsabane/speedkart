...
def cc_expire_months():
    ...
    for month in range(1, 13):
        if len(str(month)) == 1:
            ...
            numeric = str(month)
        months.append((numeric, datetime.date(2016, month, 1).strftime('%B')))
    return months
...
def strip_non_numbers(data):
    """ gets rid of all non_number characters """
...
class CheckoutForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['shipping_region'].widget.attrs['size'] = '3'
        self.fields['shipping_region'].widget.attrs['size'] = '3'
        self.fields['shipping_zip'].widget.attrs['size'] = '6'
        self.fields['billing_region'].widget.attrs['size'] = '3'
        self.fields['billing_region'].widget.attrs['size'] = '3'
